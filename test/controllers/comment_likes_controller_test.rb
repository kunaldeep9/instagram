...
class CommentLikesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create comment_like" do
    assert_difference('CommentLike.count') do
      post comment_likes_url, params: { comment_like: { comment: @comment_like.comment, like: @comment_like.like, post_id: @comment_like.post_id, record_type: @comment_like.record_type, user_id: @comment_like.user_id } }
    end
  ...
  test "should update comment_like" do
    patch comment_like_url(@comment_like), params: { comment_like: { comment: @comment_like.comment, like: @comment_like.like, post_id: @comment_like.post_id, record_type: @comment_like.record_type, user_id: @comment_like.user_id } }
