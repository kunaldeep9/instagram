class CommentLikesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @comment_like.save
        format.html { redirect_to @comment_like, notice: "Comment like was successfully created." }
  ...
  private
    ...
    def comment_like_params
      params.require(:comment_like).permit(:comment, :like, :record_type, :user_id, :post_id)
    end
end
